...
export const HorseWrapperDialog = (props: any) => {  
  const { 
    ...
    getHorseDetails, updatePedigreeData, setUpdatePedigreeData, pedigreeHorseId, setPedigreeHorseId, pedigreePosition } = props;
            ...
            <Box className='FormGroup'>
              <Box className='edit-field'>
                <Box className='CustomAutoComplete-Wrapper' mb={4}>
                  { isStallion ?
                    <SelectSire  progenyId={progenyId} prevPedigreeId={prevPedigreeId} param={"Sire"} generationId={generationId} close={close} setOpen={setOpen} getHorseDetails={getHorseDetails} openConfirm={openConfirm} newPedigreeName={newPedigreeName} setNewPedigreeName={setNewPedigreeName} updatePedigreeData={updatePedigreeData} setUpdatePedigreeData={setUpdatePedigreeData} pedigreeHorseId={pedigreeHorseId}
                    setPedigreeHorseId={setPedigreeHorseId} pedigreePosition={pedigreePosition} />
                  :
                    <SelectSire  progenyId={progenyId} prevPedigreeId={prevPedigreeId} param={"Dam"} generationId={generationId} close={close} setOpen={setOpen} getHorseDetails={getHorseDetails} openConfirm={openConfirm} newPedigreeName={newPedigreeName} setNewPedigreeName={setNewPedigreeName} updatePedigreeData={updatePedigreeData} setUpdatePedigreeData={setUpdatePedigreeData} pedigreeHorseId={pedigreeHorseId}
                    setPedigreeHorseId={setPedigreeHorseId} pedigreePosition={pedigreePosition} />
                  }                
                </Box>
                </Box>              
