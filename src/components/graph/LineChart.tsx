...
export default function LineChart(props: any) {
  ...
  // set data based on selection of values
  useEffect(() => {
    setData({});
  ...
  if (Object.keys(graphData).length) {
    return (
      <div className="lineChart-Wrapper" style={{ position: 'relative' }}>
        <Line className="lineChart" options={options} data={graphData} />
      </div>
    );
  }
