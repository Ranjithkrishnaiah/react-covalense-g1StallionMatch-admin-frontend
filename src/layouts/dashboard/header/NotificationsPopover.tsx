...
export default function NotificationsPopover() {
  ...
  const { data: unreadCountData } = useGetUnreadNotificationsTypeQuery();

  const [open, setOpen] = useState<HTMLElement | null>(null);

  const handleOpen = (event: React.MouseEvent<HTMLElement>) => {
    navigate(PATH_DASHBOARD.system.notificationfilter('unread'));
  ...
  return (
    <>
      <IconButtonAnimate
        ...
        className="NotificationIco"
      >
        <Badge
          className="notificationBadge"
          badgeContent={unreadCountData?.unreadCount}
          color="error"
        >
